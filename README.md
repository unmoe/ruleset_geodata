# 注：单独给 sing-box v1.9.0 版本的内核生成了[规则集](https://github.com/unmoe/ruleset_geodata/tree/sing-box-ruleset-compatible)
...
## 2. 数据源
① 每天凌晨 3 点（北京时间 UTC+8）自动构建，根据 [Loyalsoldier/v2ray-rules-dat](https://github.com/Loyalsoldier/v2ray-rules-dat) 和 [Loyalsoldier/geoip](https://github.com/Loyalsoldier/geoip) 进行深度定制，可点击查看包含的[域名列表](https://github.com/unmoe/domain-list-custom/tree/domains)和 [IP 段列表](https://github.com/unmoe/geoip/tree/ips)  
...
<table>
  ...
  <tr>
    ...
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/geosite-all.dat">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geosite-all.dat">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/geosite-all.dat">点此下载</a></td>
  </tr>
  <tr>
    <td>geosite-all.db</td>
    <td><code>fakeip-filter</code>、<code>private</code>、<code>ads</code>、<code>microsoft-cn</code>、<code>apple-cn</code>、<code>google-cn</code>、<code>games-cn</code>、<code>netflix</code>、<code>disney</code>、<code>max</code>、<code>primevideo</code>、<code>appletv</code>、<code>youtube</code>、<code>tiktok</code>、<code>bilibili</code>、<code>ai</code>、<code>networktest</code>、<code>proxy</code> 和 <code>cn</code></td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geosite-all.db">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@sing-box/geosite-all.db">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geosite-all.db">点此下载</a></td>
  </tr>
  <tr>
    <td>geosite-all-lite.dat</td>
    <td><code>fakeip-filter</code>、<code>private</code>、<del><code>ads</code></del>、<code>microsoft-cn</code>、<code>apple-cn</code>、<code>google-cn</code>、<code>games-cn</code>、<code>netflix</code>、<code>disney</code>、<code>max</code>、<code>primevideo</code>、<code>appletv</code>、<code>youtube</code>、<code>tiktok</code>、<code>bilibili</code>、<code>ai</code>、<code>networktest</code>、<code>proxy</code> 和 <code>cn</code></td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/geosite-all-lite.dat">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geosite-all-lite.dat">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/geosite-all-lite.dat">点此下载</a></td>
  </tr>
  <tr>
    <td>geosite-all-lite.db</td>
    <td><code>fakeip-filter</code>、<code>private</code>、<del><code>ads</code></del>、<code>microsoft-cn</code>、<code>apple-cn</code>、<code>google-cn</code>、<code>games-cn</code>、<code>netflix</code>、<code>disney</code>、<code>max</code>、<code>primevideo</code>、<code>appletv</code>、<code>youtube</code>、<code>tiktok</code>、<code>bilibili</code>、<code>ai</code>、<code>networktest</code>、<code>proxy</code> 和 <code>cn</code></td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geosite-all-lite.db">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@sing-box/geosite-all-lite.db">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geosite-all-lite.db">点此下载</a></td>
  </tr>
  <tr>
    <td>geosite.dat</td>
    ...
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/geosite.dat">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geosite.dat">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/geosite.dat">点此下载</a></td>
  </tr>
  <tr>
    <td>geosite.db</td>
    <td><code>fakeip-filter</code>、<code>private</code>、<code>ads</code>、<code>microsoft-cn</code>、<code>apple-cn</code>、<code>google-cn</code>、<code>games-cn</code>、<code>ai</code>、<code>networktest</code>、<code>proxy</code> 和 <code>cn</code></td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geosite.db">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@sing-box/geosite.db">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geosite.db">点此下载</a></td>
  </tr>
  <tr>
    ...
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/geosite-lite.dat">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geosite-lite.dat">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/geosite-lite.dat">点此下载</a></td>
  </tr>
  <tr>
    <td>geosite-lite.db</td>
    <td><code>fakeip-filter</code>、<code>private</code>、<del><code>ads</code></del>、<code>microsoft-cn</code>、<code>apple-cn</code>、<code>google-cn</code>、<code>games-cn</code>、<code>ai</code>、<code>networktest</code>、<code>proxy</code> 和 <code>cn</code></td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geosite-lite.db">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@sing-box/geosite-lite.db">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geosite-lite.db">点此下载</a></td>
  </tr>
  <tr>
    <td>geoip-all.dat</td>
    <td rowspan="4" align="center"><a href="https://github.com/Loyalsoldier/geoip/tree/release/text">点此查看</a></td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip-all.dat">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geoip-all.dat">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip-all.dat">点此下载</a></td>
  </tr>
  <tr>
    <td>Country-all.mmdb</td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/Country-all.mmdb">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/Country-all.mmdb">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/Country-all.mmdb">点此下载</a></td>
  </tr>
  <tr>
    <td>geoip-all.metadb</td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip-all.metadb">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geoip-all.metadb">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip-all.metadb">点此下载</a></td>
  </tr>
  <tr>
    <td>geoip-all.db</td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geoip-all.db">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@sing-box/geoip-all.db">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geoip-all.db">点此下载</a></td>
  </tr>
  <tr>
    ...
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/Country-ASN-all.mmdb">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/Country-ASN-all.mmdb">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/Country-ASN-all.mmdb">点此下载</a></td>
  </tr>
  <tr>
    <td>geoip.dat</td>
    <td rowspan="4"><code>netflix</code>、<code>telegram</code>、<code>private</code> 和 <code>cn</code></td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip.dat">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geoip.dat">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip.dat">点此下载</a></td>
  </tr>
  <tr>
    <td>Country.mmdb</td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/Country.mmdb">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/Country.mmdb">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/Country.mmdb">点此下载</a></td>
  </tr>
  <tr>
    <td>geoip.metadb</td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip.metadb">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geoip.metadb">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip.metadb">点此下载</a></td>
  </tr>
  <tr>
    <td>geoip.db</td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geoip.db">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@sing-box/geoip.db">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geoip.db">点此下载</a></td>
  </tr>
  <tr>
    <td>geoip-lite.dat</td>
    <td rowspan="4"><del><code>netflix</code></del>、<code>telegram</code>、<code>private</code> 和 <code>cn</code></td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip-lite.dat">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geoip-lite.dat">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip-lite.dat">点此下载</a></td>
  </tr>
  <tr>
    <td>Country-lite.mmdb</td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/Country-lite.mmdb">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/Country-lite.mmdb">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/Country-lite.mmdb">点此下载</a></td>
  </tr>
  <tr>
    <td>geoip-lite.metadb</td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip-lite.metadb">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geoip-lite.metadb">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/geoip-lite.metadb">点此下载</a></td>
  </tr>
  <tr>
    <td>geoip-lite.db</td>
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geoip-lite.db">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@sing-box/geoip-lite.db">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/sing-box/geoip-lite.db">点此下载</a></td>
  </tr>
  <tr>
    ...
    <td><a href="https://github.com/unmoe/ruleset_geodata/releases/download/clash/Country-ASN.mmdb">点此下载</a></td>
    <td><a href="https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/Country-ASN.mmdb">点此下载</a></td>
    <td><a href="https://ghp.ci/https://github.com/unmoe/ruleset_geodata/releases/download/clash/Country-ASN.mmdb">点此下载</a></td>
  </tr>
</table>
...
```
# 适用于 Clash 内核
curl -o $CRASHDIR/GeoSite.dat -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geosite.dat
curl -o $CRASHDIR/GeoIP.dat -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geoip.dat
curl -o $CRASHDIR/Country.mmdb -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/Country.mmdb
# 适用于 mihomo 内核
curl -o $CRASHDIR/geoip.metadb -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geoip.metadb
curl -o $CRASHDIR/ASN.mmdb -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/Country-ASN.mmdb
# 适用于 sing-box 内核
curl -o $CRASHDIR/geosite.db -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@sing-box/geosite.db
curl -o $CRASHDIR/geoip.db -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@sing-box/geoip.db
...
curl -o %APPDATA%\io.github.clash-verge-rev.clash-verge-rev\geosite.dat -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geosite.dat
curl -o %APPDATA%\io.github.clash-verge-rev.clash-verge-rev\geoip.dat -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geoip.dat
curl -o %APPDATA%\io.github.clash-verge-rev.clash-verge-rev\Country.mmdb -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/Country.mmdb
curl -o %APPDATA%\io.github.clash-verge-rev.clash-verge-rev\geoip.metadb -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/geoip.metadb
curl -o %APPDATA%\io.github.clash-verge-rev.clash-verge-rev\ASN.mmdb -L https://cdn.jsdelivr.net/gh/unmoe/ruleset_geodata@clash/Country-ASN.mmdb
```
</details>
...
## 2. 数据源
① 每天凌晨 3 点（北京时间 UTC+8）自动构建，根据 [Loyalsoldier/clash-rules](https://github.com/Loyalsoldier/clash-rules) 和 [Loyalsoldier/geoip](https://github.com/Loyalsoldier/geoip) 进行深度定制，可点击查看包含的[域名列表](https://github.com/unmoe/domain-list-custom/tree/domains)和 [IP 段列表](https://github.com/unmoe/geoip/tree/ips)  
...
rule-providers:
  fakeip-filter:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/fakeip-filter.mrs"
    interval: 86400
  ...
  applications:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/applications.list"
    interval: 86400
  ...
  private:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/private.mrs"
    interval: 86400
  ...
  ads:
    ...
    format: mrs
    path: ./rules/ads.mrs
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/ads.mrs"
    interval: 86400
  ...
  microsoft-cn:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/microsoft-cn.mrs"
    interval: 86400
  ...
  apple-cn:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/apple-cn.mrs"
    interval: 86400
  ...
  google-cn:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/google-cn.mrs"
    interval: 86400
  ...
  games-cn:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/games-cn.mrs"
    interval: 86400
  ...
  netflix:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/netflix.mrs"
    interval: 86400
  ...
  disney:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/disney.mrs"
    interval: 86400
  ...
  max:
    ...
    format: mrs
    path: ./rules/max.mrs
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/max.mrs"
    interval: 86400
  ...
  primevideo:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/primevideo.mrs"
    interval: 86400
  ...
  appletv:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/appletv.mrs"
    interval: 86400
  ...
  youtube:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/youtube.mrs"
    interval: 86400
  ...
  tiktok:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/tiktok.mrs"
    interval: 86400
  ...
  bilibili:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/bilibili.mrs"
    interval: 86400
  ...
  ai:
    ...
    format: mrs
    path: ./rules/ai.mrs
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/ai.mrs"
    interval: 86400
  ...
  networktest:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/networktest.list"
    interval: 86400
  ...
  proxy:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/proxy.mrs"
    interval: 86400
  ...
  cn:
    ...
    format: mrs
    path: ./rules/cn.mrs
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/cn.mrs"
    interval: 86400
  ...
  netflixip:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/netflixip.mrs"
    interval: 86400
  ...
  telegramip:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/telegramip.mrs"
    interval: 86400
  ...
  privateip:
    ...
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/privateip.mrs"
    interval: 86400
  ...
  cnip:
    ...
    format: mrs
    path: ./rules/cnip.mrs
    url: "https://github.com/unmoe/ruleset_geodata/releases/download/clash-ruleset/cnip.mrs"
    interval: 86400
    ...
    "rule_set": [
      {
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/fakeip-filter.srs"
      },
      {
        "tag": "applications",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/applications.srs"
      },
      {
        "tag": "private",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/private.srs"
      },
      {
        "tag": "ads",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/ads.srs"
      },
      {
        "tag": "microsoft-cn",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/microsoft-cn.srs"
      },
      {
        "tag": "apple-cn",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/apple-cn.srs"
      },
      {
        "tag": "google-cn",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/google-cn.srs"
      },
      {
        "tag": "games-cn",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/games-cn.srs"
      },
      {
        "tag": "netflix",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/netflix.srs"
      },
      {
        "tag": "disney",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/disney.srs"
      },
      {
        "tag": "max",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/max.srs"
      },
      {
        "tag": "primevideo",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/primevideo.srs"
      },
      {
        "tag": "appletv",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/appletv.srs"
      },
      {
        "tag": "youtube",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/youtube.srs"
      },
      {
        "tag": "tiktok",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/tiktok.srs"
      },
      {
        "tag": "bilibili",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/bilibili.srs"
      },
      {
        "tag": "ai",
        "type": "remote",
        "format": "binary",
        "path": "./ruleset/ai.srs",
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/ai.srs"
      },
      {
        "tag": "networktest",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/networktest.srs"
      },
      {
        "tag": "proxy",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/proxy.srs"
      },
      {
        "tag": "cn",
        "type": "remote",
        "format": "binary",
        "path": "./ruleset/cn.srs",
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/cn.srs"
      },
      {
        "tag": "netflixip",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/netflixip.srs"
      },
      {
        "tag": "telegramip",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/telegramip.srs"
      },
      {
        "tag": "privateip",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/privateip.srs"
      },
      {
        "tag": "cnip",
        "type": "remote",
        ...
        "url": "https://github.com/unmoe/ruleset_geodata/releases/download/sing-box-ruleset/cnip.srs"
      }
    ]
  }
}
